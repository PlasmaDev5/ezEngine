...
{
  return m_hBaseMaterial == other.m_hBaseMaterial && m_hShader == other.m_hShader && m_PermutationVars == other.m_PermutationVars && m_Parameters == other.m_Parameters && m_Texture2DBindings == other.m_Texture2DBindings && m_TextureCubeBindings == other.m_TextureCubeBindings && m_Texture3DBindings == other.m_Texture3DBindings;
}
...
ezResourceLoadDesc ezMaterialResource::UpdateContent(ezStreamReader* pOuterStream)
{
  ...
  if (sAbsFilePath.HasExtension("ezMaterialBin"))
  {
    ...
    EZ_ASSERT_DEV(uiVersion <= 7, "Unknown ezMaterialBin version {0}", uiVersion);
  ...
  if (sAbsFilePath.HasExtension("ezMaterial"))
  {
    ...
    if (pBase)
    {
      ...
      m_mDesc.m_hBaseMaterial = ezResourceManager::LoadResource<ezMaterialResource>(tmp);
    }
    ...
    if (pshader)
    {
      ...
      m_mDesc.m_hShader = ezResourceManager::LoadResource<ezShaderResource>(tmp);
    }
